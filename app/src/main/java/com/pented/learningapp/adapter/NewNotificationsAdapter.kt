...
class NewNotificationsAdapter(val notificationsModel : ArrayList<NotificationsModel>) : RecyclerView.Adapter<NewNotificationsAdapter.MyViewHolder>()  {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.llMainNoti.setBackgroundResource(R.color.extra_light_green)
    }
