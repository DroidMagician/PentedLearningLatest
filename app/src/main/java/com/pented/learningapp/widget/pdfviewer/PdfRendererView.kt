...
import com.pented.learningapp.databinding.PdfRendererviewBinding
import java.io.File
...
class PdfRendererView @JvmOverloads constructor(
    ...
    private var quality = PdfQuality.FAST
...
//        addView(binding.root)
    ...
    private fun initUnderKitkat(url: String) {
        ...
        binding.webView.webViewClient = PdfWebViewClient(statusListener)
    ...
    private fun setTypeArray(typedArray: TypedArray) {
        val ratio =
            typedArray.getInt(R.styleable.PdfRendererView_pdfView_quality, PdfQuality.FAST.ratio)
