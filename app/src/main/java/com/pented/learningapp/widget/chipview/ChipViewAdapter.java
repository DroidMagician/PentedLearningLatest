...
package com.pented.learningapp.widget.chipview;
...
//                text.setId(R.id.txtSubjectName);
...
//            }
            ...
            if (view != null) {
                TextView text = (TextView) view.findViewById(R.id.txtSubjectName);
                ...
                if (text != null) {
                    Log.e("Values","Are = "+chip.getSubject()+" "+chip.getTime()+" "+chip.getTeacherName());
                    text.setText(chip.getSubject());
                    txtTime.setText(chip.getTime());
                    txtTeacherName.setText(chip.getTeacherName());
