...
/** Builder for a dialog with a {@link CustomTrackSelectionView}. */
public final class CustomTrackSelectionDialogBuilder {
   ...
   */
  public CustomTrackSelectionDialogBuilder(
      Context context,
      CharSequence title,
   ...
   */
  public CustomTrackSelectionDialogBuilder setTheme(@StyleRes int themeResId) {
   ...
   * @return This builder, for convenience.
   */
  public CustomTrackSelectionDialogBuilder setIsDisabled(boolean isDisabled) {
   ...
   * @return This builder, for convenience.
   */
  public CustomTrackSelectionDialogBuilder setOverride(@Nullable SelectionOverride override) {
    return setOverrides(
   ...
   * @return This builder, for convenience.
   */
  public CustomTrackSelectionDialogBuilder setOverrides(List<SelectionOverride> overrides) {
   ...
   * @return This builder, for convenience.
   */
  public CustomTrackSelectionDialogBuilder setAllowAdaptiveSelections(boolean allowAdaptiveSelections) {
   ...
   * @return This builder, for convenience.
   */
  public CustomTrackSelectionDialogBuilder setAllowMultipleOverrides(boolean allowMultipleOverrides) {
   ...
   * @return This builder, for convenience.
   */
  public CustomTrackSelectionDialogBuilder setShowDisableOption(boolean showDisableOption) {
   ...
   */
  public CustomTrackSelectionDialogBuilder setTrackNameProvider(
  ...
  private Dialog buildForPlatform() {
    ...
    View dialogView = dialogInflater.inflate(R.layout.exo_track_selection_dialog_custom, /* root= */ null);
    Dialog.OnClickListener okClickListener = setUpDialogView(dialogView);

    return builder
        .setTitle(title)
        .setView(dialogView)
        .setPositiveButton(R.string.okdialog, okClickListener)
  ...
  private Dialog buildForAndroidX() {
    try {
      ...
      View dialogView =
          dialogInflater.inflate(R.layout.exo_track_selection_dialog_custom, /* root= */ null);
      Dialog.OnClickListener okClickListener = setUpDialogView(dialogView);
      ...
      builderClazz
          ...
          .invoke(builder,R.string.okdialog, okClickListener);
      builderClazz
          .getMethod("setNegativeButton", int.class, DialogInterface.OnClickListener.class)
          .invoke(builder, R.string.cancelDialog, null);
  ...
  private Dialog.OnClickListener setUpDialogView(View dialogView) {
    CustomTrackSelectionView selectionView = dialogView.findViewById(R.id.exo_track_selection_view);
