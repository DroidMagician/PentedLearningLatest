...
public class CustomTrackSelectionView extends LinearLayout {
  ...
  public CustomTrackSelectionView(
    ...
    disableView.setText(com.google.android.exoplayer2.R.string.exo_track_selection_none);
    ...
    addView(disableView);
    // Divider view.
    addView(inflater.inflate(com.google.android.exoplayer2.R.layout.exo_list_divider, this, false));
