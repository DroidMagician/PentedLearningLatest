package com.pented.learningapp.helper.cropper.utils
...
private fun getFileExtension(context: Context, uri: Uri): String? =
  if (uri.scheme == ContentResolver.SCHEME_CONTENT) {
    ...
    uri.path?.let { MimeTypeMap.getFileExtensionFromUrl(FileProvider.getUriForFile(context.getApplicationContext(), context.getPackageName()+".fileprovider", File(it)).toString()) }
  }
