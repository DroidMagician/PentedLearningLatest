...
import com.pented.learningapp.helper.cropper.CropImageView.RequestSizeOptions
  ...
  private fun buildUri(
    ...
    try {
      ...
      if (SDK_INT >= 29) {
        ...
        FileProvider.getUriForFile(context.getApplicationContext(), context.getPackageName()+".fileprovider",File.createTempFile("cropped", ext, context.cacheDir))
      }
    } catch (e: IOException) {
