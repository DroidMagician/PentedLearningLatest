...
class SubjectContainerAdapter(private val context: Context, private val sections : ArrayList<SubjectRecyclerViewSection>) : RecyclerView.Adapter<SubjectContainerAdapter.ViewHolder>() {
    ...
    class ViewHolder(private val view : View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(context : Context, section : SubjectRecyclerViewSection) {
