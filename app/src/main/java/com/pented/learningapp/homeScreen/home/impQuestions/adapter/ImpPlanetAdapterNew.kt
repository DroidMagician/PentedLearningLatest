package com.pented.learningapp.homeScreen.home.impQuestions.adapter
...
import com.pented.learningapp.homeScreen.home.impQuestions.WatchImpVideoActivity
...
class ImpPlanetAdapterNew(val planetsModel: ArrayList<GetImpQuestionResponseModel.Data>, val context: Context) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (itemType == TYPE_LEFT) {
            ...
            viewHolderLeft.tvTopicNameLeft.text = model.TopicVideoTitle
            ...
            model.planet_img?.let { viewHolderLeft.ivPlanetLeft.setImageResource(it) }
            ...
            viewHolderLeft.txtStartNowLeft.setOnClickListener {
                context.sendBroadcast(Intent("StartNowIMP"))
            }
//            if (position == planetsModel.lastIndex){
//                Log.e("Postion is","Here left"+position)
...
//                }
               ...
               // notifyDataSetChanged()
                var intent = Intent(context,WatchImpVideoActivity::class.java)
                var dataString: String = Gson().toJson(model)
                Constants.isFromNormalVideoList = false
                intent.putExtra("topicVideo",dataString)
            ...
            viewHolderright.tvTopicNameRight.text = model.TopicVideoTitle
            ...
            model.planet_img?.let { viewHolderright.ivPlanetRight.setImageResource(it) }
            if(model.isRocketVisible)
            {
